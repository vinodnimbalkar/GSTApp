...
public class Services28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_services28);
        data = (TextView) findViewById(R.id.services28data);
        get_json();
    }
    ...
    public void get_json() {
        ...
        String result = "";
        try {
            InputStream is = getAssets().open("S28.json");
            ...
            Services28.data.setText(result);
