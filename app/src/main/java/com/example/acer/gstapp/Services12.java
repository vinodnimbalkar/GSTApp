...
public class Services12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_services12);
        data = (TextView) findViewById(R.id.services12data);
        get_json();
    }
    public void get_json(){
        ...
        String result = "";
        try {
            InputStream is = getAssets().open("S12.json");
            ...
            Services12.data.setText(result);
