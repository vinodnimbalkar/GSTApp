...
public class Services5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_services5);
        data = (TextView) findViewById(R.id.services5data);
        get_json();
    }
    public void get_json(){
        ...
        String result = "";
        try {
            InputStream is = getAssets().open("S5.json");
