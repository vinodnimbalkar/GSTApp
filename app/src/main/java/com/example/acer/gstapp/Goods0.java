...
public class Goods0 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = (TextView) findViewById(R.id.goods0data);
        listData = (ListView) findViewById(R.id.goods0list) ;
        get_json();
    }
    ...
    public void get_json(){
        ...
        String result = "";
        try {
            InputStream is = getAssets().open("G0.json");
